...
/*   Updated: 2024/11/20 12:31:50 by rmarzouk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_mlx_elements(t_data *data)
{
	...
	*/
	...
	mlx_delete_texture(data->texture_img1);
	mlx_delete_texture(data->texture_img2);
	mlx_delete_texture(data->texture_img3);
	mlx_delete_texture(data->texture_img4);
